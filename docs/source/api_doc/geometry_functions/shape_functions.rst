...
The shape functions methods can be accessed from the ``pysdic.geometry`` module.
...
- **shape_functions** : :class:`numpy.ndarray` of shape (M, :math:`N_{vpe}`)
    An array containing the evaluated shape functions at the specified points for the N nodes of the element.
...
.. autosummary::
   :toctree: ../../generated/geometry_functions/
...
.. seealso::
    ...
    - :class:`pysdic.geometry.Mesh` : Class representing a finite element mesh structure.