...
def test_remap_vertices_coordinates():
    ...
    remapped_coordinates = pg.remap_vertices_coordinates(
...
def test_assemble_shape_function_matrix():
    ...
    shape_function_matrix = pg.assemble_shape_function_matrix(shape_functions, element_connectivity, element_indices, vertices_number=10)
...
def test_assemble_shape_function_matrix_with_m1():
    ...
    default = 42.15
    shape_function_matrix = pg.assemble_shape_function_matrix(
        shape_functions,
        element_connectivity,
        element_indices,
        vertices_number=10,
...
def test_assemble_shape_function_matrix_sparse_versus_dense():
    ...
    shape_function_matrix_dense = pg.assemble_shape_function_matrix(
        shape_functions,
        element_connectivity,
        element_indices,
        vertices_number=10,
    ...
    shape_function_matrix_sparse = pg.assemble_shape_function_matrix(
        shape_functions,
        element_connectivity,
        element_indices,
        vertices_number=10,
...
def test_interpolate_property():
    ...
    interpolated_properties = pg.interpolate_property(
        vertex_properties,
        shape_functions,
        element_connectivity,
        element_indices
