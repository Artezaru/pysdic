...
class Camera(object):
    ...
    def project(self, world_points: numpy.ndarray, dx: bool = False, dintrinsic: bool = False, ddistortion: bool = False, dextrinsic: bool = False) -> ProjectionResult:
        ...
        result = pycvcam.project_points(world_points, self.intrinsic, self.distortion, self.extrinsic, dx=dx, dintrinsic=dintrinsic, ddistortion=ddistortion, dextrinsic=dextrinsic)
